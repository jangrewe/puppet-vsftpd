...
class vsftpd (
  ...
  $pasv_address_resolve    = params_lookup( 'pasv_address_resolve' ),
  ...
  $bool_pasv_address_resolve=any2bool($pasv_address_resolve)
  ...
  $real_pasv_address_resolve = $vsftpd::bool_pasv_address_resolve ? {
    true  => 'YES',
    false => 'NO',
  }
